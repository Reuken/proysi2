...
//    });
 ...
 //    Route::get('summary/create', function ()    {
    ...
    Route::get('users/crear','usersController@crear');
    ...
    Route::get('balance/balance/mayor','accountController@mayor');
    Route::get('balance/balance/diario','accountController@diario');

...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a  href="#"><i class='fa fa-balance-scale'></i> <span>Balance y Libros</span>  <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{ url('balance/balance/add') }}">Ingresos</a></li>
                    <li><a href="{{ url('balance/balance/out') }}">Egresos</a></li>
                    <li><a href="{{ url('balance/balance/diario') }}">Libro Diario</a></li>
                    <li><a href="{{ url('balance/balance/mayor') }}">Libro Mayor</a></li>
                </ul>
            </li>

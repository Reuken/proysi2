      ...
      if($r>0 ){  
       ...
       $totalm6 = 0;      
        ...
        if($totalm6<0){
            $para      = $logemail;
            $titulo    = 'Notificacion del sistema de finanzas';
            $mensaje   = '<table cellpadding="0" cellspacing="0" width="640px" height="500px"><tbody><tr style="background-color:rgba(68,66,65,0.68);height:10px"><td></td><td> <div style="margin-left:120px;margin-top:35px" alt="Space Invaders" width="180" class="CToWUd a6T" tabindex="0"><div class="a6S" dir="ltr" style="opacity: 0.01; left: 489px; top: 135px;"><div id=":2bd" class="T-I J-J5-Ji aQv T-I-ax7 L3 a5q" role="button" tabindex="0" aria-label="Descargar el archivo adjunto " data-tooltip-class="a1V" data-tooltip="Descargar"><div class="aSK J-J5-Ji aYr"></div></div></div>    </td></tr><tr><td></td><td><p style="color:#fff;margin-left:0px;font-size:18px;width:300px;padding:10px;border-radius:10px;text-align:center;background-color:rgba(42, 41, 41, 0.92);">tienes  una proyección de gastos para los proximos 180 dias, con  una liquidez  negativa mayor a las ganancias o abonos registrados hasta la fecha. </p><h3 style="color:white;margin-left:60px"><a style="background-color:white;color:#111;border-radius:10px;text-align:center;padding-top:10px;padding-bottom:10px;padding-right:20px;padding-left:20px;margin-top:10em;margin-bottom:10em;text-decoration:none target="_blank" >clik Para ir al panel </a></h3></td></tr><tr><td> </td><td></td></tr></tbody></table>';
            $cabeceras = "MIME-Version: 1.0" . "\r\n";
            $cabeceras.= "Content-type:text/html;charset=UTF-8" . "\r\n";
            mail($para, $titulo, $mensaje, $cabeceras);
